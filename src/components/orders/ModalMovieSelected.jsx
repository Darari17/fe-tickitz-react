...
//           <img
//             src={cinemaLogo || "/default-cinema-logo.svg"}
...
//               {seatSelected.length > 0 ? seatSelected.join(", ") : "-"}
//             </span>
//           </div>
//         </div>
...
//       <Link
//         to="/payment"
//         className="block w-full py-3 mt-4 font-medium text-center text-white transition bg-blue-600 rounded-md hover:bg-blue-700"
//       >
//         Checkout now
//       </Link>
//     </div>
